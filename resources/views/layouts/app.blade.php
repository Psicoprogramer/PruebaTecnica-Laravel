    ...
    <div id="app">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <div class="container-nav">
                            <a class="nav-a" href="{{route('product.index')}}">Home</a>
                            <a  class="nav-a" href="{{route('product.create')}}">Add Producto</a>
                            <a class="nav-a" href="{{route('empleado.index')}}">Empleados</a>
                        </div>
        ...
        <main class="py-4">
            ...
            <footer class="text-sm leading-[1.75] mt-4">
                <div>
                  Hecho con <span class="footer-span">❤</span>	por 
                  <a
                    ...
                    href={"https://github.com/Psicoprogramer"}
                    target="_blank"
                  >
                    @BrayanCDiez</a>
                </div>
